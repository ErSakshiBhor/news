...
const NewsItem = (props)=> {
    ...
    return (
      <div>
        <div className="my-3">
        <div className="card" >
            <img src={imageUrl || placeholderImage} className="card-img-top" alt={title || 'News Image'} />
            <div className="card-body">
                ...
                <p className='card-text'><small className='text-muted'>By {!author ? 'Unknown' : author} on {date ? new Date(date).toGMTString() : 'Unknown date'}</small></p>
